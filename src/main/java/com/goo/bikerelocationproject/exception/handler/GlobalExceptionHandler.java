...
import com.goo.bikerelocationproject.data.ErrorDto;
...
public class GlobalExceptionHandler {
  ...
  public ErrorDto handleOpenApiException(OpenApiException e) {
    LOGGER.error("[open-api error]: " + e);

    return new ErrorDto(e.getOpenApiDataType(), e.getCode(), e.getMessage());
  }
